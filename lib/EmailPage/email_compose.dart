...
class ComposeEmailForm extends StatefulWidget {
  final EmailResponse? initialDetails;
  ComposeEmailForm({this.initialDetails});
  @override
...
// class _ComposeEmailFormState extends State<ComposeEmailForm> with WidgetsBindingObserver {
//   final _formKey = GlobalKey<FormState>();
//   final TextEditingController _subjectController = TextEditingController();
//   final TextEditingController _bodyController = TextEditingController();
